...
export default function AdvancedPracticePage() {
  ...
  const allForTest = useMemo(() => [...legacyHardenedQuestionBank, ...advancedQuestionBank, ...questionBank2027].filter(q => q.test === test), [test])
