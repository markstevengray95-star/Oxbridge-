...
export default async function AdminPage() {
  ...
  return <main className="min-h-screen bg-[#eef3f4] px-4 py-7 text-[#172b3a] sm:px-6 lg:px-8 lg:py-10"><div className="mx-auto max-w-7xl space-y-6">
    <div className="flex flex-wrap items-center justify-between gap-4"><div><div className="flex items-center gap-2"><Badge className="bg-[#102a43] text-white"><ShieldCheck className="size-3.5" />Administrator</Badge><Badge variant="outline">Unrestricted access</Badge></div><h1 className="mt-3 font-serif text-4xl font-bold">ScholarBridge Admin Console</h1><p className="mt-2 max-w-2xl text-sm leading-6 text-[#667984]">Server-verified unrestricted access across Pro, School, AI, voice, user-management and quality-control features.</p></div><div className="flex gap-2"><Button asChild variant="outline"><Link href="/account">Account</Link></Button><Button asChild><Link href="/tutor"><Brain />Open Tutor</Link></Button></div></div>
