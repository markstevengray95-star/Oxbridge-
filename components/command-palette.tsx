...
const destinations = [
  ...
  { label:"ElevenLabs Live Interview", href:"/elevenlabs-interview", keywords:"elevenlabs natural voice realtime interview microphone gpt 5.6" },
  { label:"OpenAI Live Voice", href:"/live-interview", keywords:"voice realtime interview microphone openai" },
