...
import { AudioLines, Brain, Home, Sparkles, Target } from "lucide-react"
...
const items = [
  ...
  { href: "/live-interview", label: "Live Voice", icon: AudioLines },
